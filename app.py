...
relevant_list = ['Has relevent experience', 'No relevent experience']
job_list = ['1', '>4', 'never', '4', '3', '2']
major_list = ['STEM', 'Business Degree', 'Arts', 'Humanities', 'No Major',
       'Other']
...
relevant_experience = st.selectbox(label="Has Relevant Experience", options = relevant_list)
last_new_job = st.selectbox(label="Last Job", options = job_list)
major_discipline = st.selectbox(label="Major Discipline", options = major_list)
